...
[[https://justin.abrah.ms/emacs/literate_programming.html][introduction to tangling]].

** TODO Ruby functions to create instance variables
** TODO Fix mode line
** TODO pairing mode
** TODO ruty
** TODO Server
** TODO Autocompile on tangle of this file
** TODO Switch back to helm, or work out how to add actions to ivy
...
I use smart mode line to make it prettier/easier to read, and then add
some extra info:
...
Use yasnippets everywhere. I override the default snippets by
symlinking the ~/emacs.d/snippets directory.
